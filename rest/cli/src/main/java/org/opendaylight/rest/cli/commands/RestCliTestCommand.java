 ...
 */
package org.opendaylight.rest.cli.commands;
...
public class RestCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(RestCliTestCommand.class);
    protected final RestCliCommands service;

    public RestCliTestCommand(final RestCliCommands service) {
