...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.rms.rev150105.HelloInputBuilder;
...
public class Rest {
    ...
    public String getResult(){
        ...
        RmsService rmsService = rpcProviderRegistry.getRpcService(RmsService.class);
