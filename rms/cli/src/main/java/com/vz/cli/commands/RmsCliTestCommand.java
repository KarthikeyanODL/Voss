...
public class RmsCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(RmsCliTestCommand.class);
    protected final RmsCliCommands service;

    public RmsCliTestCommand(final RmsCliCommands service) {
